...
alias com {
  echo "\[exec\] com"
    ...
    eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dpram_32inx64/sim/dpram_32inx64.v" -work dpram_32inx64
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_170 -L fifo_69x8192 -L fifo_74in_37out -L fifo_512inx64out -L fifo_34inx64 -L dcfifo_33inx256 -L fifo_256in_32out -L fifo_256inx512 -L fifo_148in_37out -L fifo_135inx512 -L scfifo_37inx512 -L ram_2port_170 -L dpram_32inx64 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
