...
#vlog -sv $PRO_DIR/rtl/timer.v
#vlog -sv $PRO_DIR/rtl/buffer.sv
#vlog -sv $PRO_DIR/rtl/avalon_frame_convert.sv
...
#wps_top_tb
vlog -sv $PRO_DIR/software/hdmi/tb/wps_top_tb.sv
vlog -sv $PRO_DIR/software/hdmi/rtl/ddr3_usr_logic.v
vlog -sv $PRO_DIR/software/hdmi/rtl/interface_256in_24out.v
vlog -sv $PRO_DIR/software/hdmi/rtl/wps_top.v
vlog -sv $PRO_DIR/software/hdmi/rtl/wps_controller.v
vlog -sv $PRO_DIR/software/hdmi/rtl/pingpongFIFO.v
...
#run -a
#exit -code 0
do $PRO_DIR/software/hdmi/modelsim/wps_top_wave.do
#ls radix hex
run 20 ms
