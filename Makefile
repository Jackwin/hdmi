...
C_SRCS += HDMI_Lib/HDMI_TX/EDID.c
C_SRCS += HDMI_Lib/HDMI_TX/HDMI_TX.c
C_SRCS += HDMI_Lib/HDMI_TX/dss_sha.c
C_SRCS += HDMI_Lib/HDMI_TX/it6613_drv.c
C_SRCS += HDMI_Lib/HDMI_TX/it6613_sys.c
C_SRCS += HDMI_Lib/mcu.c
C_SRCS += terasic_lib/I2C.c
C_SRCS += terasic_lib/debug.c
C_SRCS += main.c
CXX_SRCS :=
ASM_SRCS :=
